...
in
{
  "secrets/stalwart-admin.age".publicKeys = keys [
    tseeley
    server-mail
  ];
  "secrets/directus-secret.age".publicKeys = keys [
    tseeley
    server-services
  ];
  "secrets/directus-admin.age".publicKeys = keys [
    tseeley
    server-services
  ];
  "secrets/directus-db-password.age".publicKeys = keys [
    tseeley
    server-services
  ];
  "secrets/umami-app-secret.age".publicKeys = keys [
    tseeley
    server-services
  ];
  "secrets/umami-db-password.age".publicKeys = keys [
    tseeley
    server-services
  ];
  ...
  "secrets/tailscale-authkey.age".publicKeys = keys [
    tseeley
    server-media
  ];
  "secrets/tailscale-authkey-services.age".publicKeys = keys [
    tseeley
    server-services
  ];
